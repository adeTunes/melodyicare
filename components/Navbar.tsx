    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link
            href="/register"
            className="px-6 py-2.5 bg-secondary text-white rounded-full text-sm font-semibold hover:bg-secondary/90 transition-all shadow-sm hover:shadow-md active:scale-95"
          >
            Get Started
          </Link>
        </div>
        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="/register"
                className="mt-2 w-full py-3 bg-secondary text-white rounded-xl text-center font-bold shadow-sm"
                onClick={() => setIsOpen(false)}
              >
                Get Started
              </Link>
